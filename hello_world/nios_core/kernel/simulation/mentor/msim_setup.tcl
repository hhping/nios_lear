...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"            -work sdram_ctrl_s1_rsp_width_adapter           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"        -work sdram_ctrl_s1_rsp_width_adapter           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"       -work sdram_ctrl_s1_rsp_width_adapter           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"               -work rsp_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_rsp_mux_001.sv"   -work rsp_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"               -work rsp_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_rsp_mux.sv"       -work rsp_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_rsp_demux_001.sv" -work rsp_demux_001                             
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_rsp_demux.sv"     -work rsp_demux                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"               -work cmd_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_cmd_mux_001.sv"   -work cmd_mux_001                               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"               -work cmd_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_cmd_mux.sv"       -work cmd_mux                                   
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_cmd_demux_001.sv" -work cmd_demux_001                             
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_cmd_demux.sv"     -work cmd_demux                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"            -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"     -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"       -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"        -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"            -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"            -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"         -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"        -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"        -work sdram_ctrl_s1_burst_adapter               
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"          -work sdram_ctrl_s1_burst_adapter               
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_router_010.sv"    -work router_010                                
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_router_003.sv"    -work router_003                                
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_router_002.sv"    -work router_002                                
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_router_001.sv"    -work router_001                                
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_mm_interconnect_0_router.sv"        -work router                                    
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/kernel_irq_mapper.sv"                      -work irq_mapper                                
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L sdram_ctrl_s1_rsp_width_adapter -L rsp_mux_001 -L rsp_mux -L rsp_demux_001 -L rsp_demux -L cmd_mux_001 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L sdram_ctrl_s1_burst_adapter -L cpu_data_master_limiter -L router_010 -L router_003 -L router_002 -L router_001 -L router -L jtag_uart_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_avalon_jtag_slave_agent -L cpu_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L cpu_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_0 -L uart -L sysid -L sdram_ctrl -L onchip_memory -L jtag_uart -L epcs -L cf_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
