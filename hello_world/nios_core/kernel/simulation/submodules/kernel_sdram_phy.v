...
// ============================================================
// Megafunction Name(s):
// 			kernel_sdram_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 14.1 [Altera, IP Toolbench 1.3.0 Build 186]
// ************************************************************
...
module kernel_sdram_phy (
	...
	kernel_sdram_phy_alt_mem_phy	kernel_sdram_phy_alt_mem_phy_inst(
	...
	defparam
		kernel_sdram_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		kernel_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		kernel_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		kernel_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		kernel_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		kernel_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		kernel_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		kernel_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 14,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6000,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6000 ps",
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1106,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		kernel_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		kernel_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		kernel_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		kernel_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		kernel_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="14.1"  build="198"  iptb_version="1.3.0 Build 186"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="kernel_sdram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_mhz" value="166.666"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (Micron MT47H32M16CC-3)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="kernel_sdram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="kernel_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+kernel_sdram_phy_alt_mem_phy_seq_wrapper;+kernel_sdram_phy_alt_mem_phy_reconfig;+kernel_sdram_phy_alt_mem_phy_pll;+kernel_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\ADMINI~1\AppData\Local\Temp\alt7755_2007488580102944152.dir\0005_iptb_gen/kernel_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="kernel_sdram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: kernel_sdram_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================
