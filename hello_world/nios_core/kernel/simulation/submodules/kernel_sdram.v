...
// ============================================================
// Megafunction Name(s):
// 			kernel_sdram_controller_phy
// ============================================================
// Generated by DDR2 High Performance Controller 14.1 [Altera, IP Toolbench 1.3.0 Build 186]
// ************************************************************
...
module kernel_sdram (
	...
	kernel_sdram_controller_phy	kernel_sdram_controller_phy_inst(
...
// Retrieval info: <MEGACORE title="DDR2 SDRAM Controller with ALTMEMPHY"  version="14.1"  build="186"  iptb_version="1.3.0 Build 186"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="kernel_sdram_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="kernel_sdram_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="kernel_sdram_phy_alt_mem_phy_seq.vhd,kernel_sdram_phy_alt_mem_phy_seq_wrapper.vhd,kernel_sdram_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "native" value="verilog"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="kernel_sdram_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+kernel_sdram_alt_mem_phy_seq_wrapper;+kernel_sdram_alt_mem_phy_reconfig;+kernel_sdram_alt_mem_phy_pll;+kernel_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\ADMINI~1\AppData\Local\Temp\alt7755_2007488580102944152.dir\0005_iptb_gen/kernel_sdram_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="kernel_sdram_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
