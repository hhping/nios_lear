...
// 
// Generated using ACDS version 14.1 186 at 2018.08.23.22:33:57
...
module kernel_mm_interconnect_0 (
		...
		output wire [25:0] sdram_ctrl_s1_address,                   //                   sdram_ctrl_s1.address
	...
	wire   [27:0] cf_0_ctl_agent_m0_address;                                                 // cf_0_ctl_agent:m0_address -> cf_0_ctl_translator:uav_address
	...
	wire  [106:0] cf_0_ctl_agent_rf_source_data;                                             // cf_0_ctl_agent:rf_source_data -> cf_0_ctl_agent_rsp_fifo:in_data
	...
	wire  [106:0] cf_0_ctl_agent_rsp_fifo_out_data;                                          // cf_0_ctl_agent_rsp_fifo:out_data -> cf_0_ctl_agent:rf_sink_data
	...
	wire          cf_0_ctl_agent_rdata_fifo_src_valid;                                       // cf_0_ctl_agent:rdata_fifo_src_valid -> cf_0_ctl_agent:rdata_fifo_sink_valid
	wire   [33:0] cf_0_ctl_agent_rdata_fifo_src_data;                                        // cf_0_ctl_agent:rdata_fifo_src_data -> cf_0_ctl_agent:rdata_fifo_sink_data
	wire          cf_0_ctl_agent_rdata_fifo_src_ready;                                       // cf_0_ctl_agent:rdata_fifo_sink_ready -> cf_0_ctl_agent:rdata_fifo_src_ready
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> cf_0_ctl_agent:cp_valid
	wire  [105:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cf_0_ctl_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // cf_0_ctl_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cf_0_ctl_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> cf_0_ctl_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> cf_0_ctl_agent:cp_endofpacket
	...
	wire   [27:0] epcs_epcs_control_port_agent_m0_address;                                   // epcs_epcs_control_port_agent:m0_address -> epcs_epcs_control_port_translator:uav_address
	...
	wire  [106:0] epcs_epcs_control_port_agent_rf_source_data;                               // epcs_epcs_control_port_agent:rf_source_data -> epcs_epcs_control_port_agent_rsp_fifo:in_data
	...
	wire  [106:0] epcs_epcs_control_port_agent_rsp_fifo_out_data;                            // epcs_epcs_control_port_agent_rsp_fifo:out_data -> epcs_epcs_control_port_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> epcs_epcs_control_port_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                     // epcs_epcs_control_port_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> epcs_epcs_control_port_agent:cp_channel
	...
	wire   [27:0] cf_0_ide_agent_m0_address;                                                 // cf_0_ide_agent:m0_address -> cf_0_ide_translator:uav_address
	...
	wire  [106:0] cf_0_ide_agent_rf_source_data;                                             // cf_0_ide_agent:rf_source_data -> cf_0_ide_agent_rsp_fifo:in_data
	...
	wire  [106:0] cf_0_ide_agent_rsp_fifo_out_data;                                          // cf_0_ide_agent_rsp_fifo:out_data -> cf_0_ide_agent:rf_sink_data
	...
	wire          cf_0_ide_agent_rdata_fifo_src_valid;                                       // cf_0_ide_agent:rdata_fifo_src_valid -> cf_0_ide_agent:rdata_fifo_sink_valid
	wire   [33:0] cf_0_ide_agent_rdata_fifo_src_data;                                        // cf_0_ide_agent:rdata_fifo_src_data -> cf_0_ide_agent:rdata_fifo_sink_data
	wire          cf_0_ide_agent_rdata_fifo_src_ready;                                       // cf_0_ide_agent:rdata_fifo_sink_ready -> cf_0_ide_agent:rdata_fifo_src_ready
	wire          cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> cf_0_ide_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> cf_0_ide_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // cf_0_ide_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> cf_0_ide_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> cf_0_ide_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> cf_0_ide_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> uart_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire   [27:0] sdram_ctrl_s1_agent_m0_address;                                            // sdram_ctrl_s1_agent:m0_address -> sdram_ctrl_s1_translator:uav_address
	...
	wire   [88:0] sdram_ctrl_s1_agent_rf_source_data;                                        // sdram_ctrl_s1_agent:rf_source_data -> sdram_ctrl_s1_agent_rsp_fifo:in_data
	...
	wire   [88:0] sdram_ctrl_s1_agent_rsp_fifo_out_data;                                     // sdram_ctrl_s1_agent_rsp_fifo:out_data -> sdram_ctrl_s1_agent:rf_sink_data
	...
	wire          sdram_ctrl_s1_agent_rdata_fifo_out_valid;                                  // sdram_ctrl_s1_agent_rdata_fifo:out_valid -> sdram_ctrl_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] sdram_ctrl_s1_agent_rdata_fifo_out_data;                                   // sdram_ctrl_s1_agent_rdata_fifo:out_data -> sdram_ctrl_s1_agent:rdata_fifo_sink_data
	wire          sdram_ctrl_s1_agent_rdata_fifo_out_ready;                                  // sdram_ctrl_s1_agent:rdata_fifo_sink_ready -> sdram_ctrl_s1_agent_rdata_fifo:out_ready
	...
	wire          cf_0_ctl_agent_rp_valid;                                                   // cf_0_ctl_agent:rp_valid -> router_004:sink_valid
	wire  [105:0] cf_0_ctl_agent_rp_data;                                                    // cf_0_ctl_agent:rp_data -> router_004:sink_data
	wire          cf_0_ctl_agent_rp_ready;                                                   // router_004:sink_ready -> cf_0_ctl_agent:rp_ready
	wire          cf_0_ctl_agent_rp_startofpacket;                                           // cf_0_ctl_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          cf_0_ctl_agent_rp_endofpacket;                                             // cf_0_ctl_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [105:0] epcs_epcs_control_port_agent_rp_data;                                      // epcs_epcs_control_port_agent:rp_data -> router_006:sink_data
	...
	wire          cf_0_ide_agent_rp_valid;                                                   // cf_0_ide_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] cf_0_ide_agent_rp_data;                                                    // cf_0_ide_agent:rp_data -> router_007:sink_data
	wire          cf_0_ide_agent_rp_ready;                                                   // router_007:sink_ready -> cf_0_ide_agent:rp_ready
	wire          cf_0_ide_agent_rp_startofpacket;                                           // cf_0_ide_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          cf_0_ide_agent_rp_endofpacket;                                             // cf_0_ide_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [105:0] uart_s1_agent_rp_data;                                                     // uart_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [105:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_009:sink_data
	...
	wire   [87:0] sdram_ctrl_s1_agent_rp_data;                                               // sdram_ctrl_s1_agent:rp_data -> router_010:sink_data
	...
	wire   [87:0] sdram_ctrl_s1_burst_adapter_source0_data;                                  // sdram_ctrl_s1_burst_adapter:source0_data -> sdram_ctrl_s1_agent:cp_data
	...
	wire    [8:0] cmd_demux_001_src4_channel;                                                // cmd_demux_001:src4_channel -> cmd_mux_006:sink1_channel
	...
	wire    [8:0] rsp_demux_006_src1_channel;                                                // rsp_demux_006:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire   [87:0] router_010_src_data;                                                       // router_010:src_data -> sdram_ctrl_s1_rsp_width_adapter:in_data
	wire          router_010_src_ready;                                                      // sdram_ctrl_s1_rsp_width_adapter:in_ready -> router_010:src_ready
	wire    [8:0] router_010_src_channel;                                                    // router_010:src_channel -> sdram_ctrl_s1_rsp_width_adapter:in_channel
	...
	wire          sdram_ctrl_s1_rsp_width_adapter_src_valid;                                 // sdram_ctrl_s1_rsp_width_adapter:out_valid -> rsp_demux_008:sink_valid
	wire  [105:0] sdram_ctrl_s1_rsp_width_adapter_src_data;                                  // sdram_ctrl_s1_rsp_width_adapter:out_data -> rsp_demux_008:sink_data
	wire          sdram_ctrl_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_008:sink_ready -> sdram_ctrl_s1_rsp_width_adapter:out_ready
	wire    [8:0] sdram_ctrl_s1_rsp_width_adapter_src_channel;                               // sdram_ctrl_s1_rsp_width_adapter:out_channel -> rsp_demux_008:sink_channel
	wire          sdram_ctrl_s1_rsp_width_adapter_src_startofpacket;                         // sdram_ctrl_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_008:sink_startofpacket
	wire          sdram_ctrl_s1_rsp_width_adapter_src_endofpacket;                           // sdram_ctrl_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_008:sink_endofpacket
	wire          cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> sdram_ctrl_s1_cmd_width_adapter:in_valid
	wire  [105:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> sdram_ctrl_s1_cmd_width_adapter:in_data
	wire          cmd_mux_008_src_ready;                                                     // sdram_ctrl_s1_cmd_width_adapter:in_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> sdram_ctrl_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> sdram_ctrl_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> sdram_ctrl_s1_cmd_width_adapter:in_endofpacket
	...
	wire   [87:0] sdram_ctrl_s1_cmd_width_adapter_src_data;                                  // sdram_ctrl_s1_cmd_width_adapter:out_data -> sdram_ctrl_s1_burst_adapter:sink0_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (cf_0_ctl_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (cf_0_ctl_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (cf_0_ctl_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (cf_0_ide_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (cf_0_ide_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (cf_0_ide_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (sdram_ctrl_s1_agent_rdata_fifo_out_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (sdram_ctrl_s1_agent_rdata_fifo_out_valid),          //                .valid
		.rdata_fifo_sink_data    (sdram_ctrl_s1_agent_rdata_fifo_out_data),           //                .data
	...
	kernel_mm_interconnect_0_router_003 router_007 (
	...
	kernel_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kernel_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
